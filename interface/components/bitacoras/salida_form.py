...
class SalidaFormWidget(QWidget):
    ...
    def fetch_tipos_observaciones(self):
        log("[SALIDA FORM]: Obteniendo tipos de observaciones...")
        self.runner.run(
            func=FObservaciones.lista_tipos,
            on_error=lambda e: log(f"[SALIDA FORM]: Ocurrio un error -> {e}"),
    ...
    def agregar_combo(self, datos, combobox): 
        log("[SALIDA FORM]: Agregando los datos al combobox...")
        
        combobox.addItems(datos)
        
        log("[SALIDA FORM]: Datos agregados.")