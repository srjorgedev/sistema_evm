...
class Observacion:
    ...
    def get_tipoObservacion(self):
        return self.__tipoObservacion
    def get_bitacoraAsociada(self):
        return self.__bitacoraAsociada
    ...
    def set_descripcion(self, descripcion):
        self.__descripcion = descripcion
    def set_tipoObservacion(self, tipoObservacion):
        self.__tipoObservacion = tipoObservacion
    def set_bitacoraAsociada(self, bitacoraAsociada):
        self.__bitacoraAsociada = bitacoraAsociada